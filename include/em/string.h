 ...
 *
 */
#ifndef __EM_STRING_H__
#define __EM_STRING_H__
...
/**
 * @defgroup EM_PSTR String Operations
 * @ingroup EM_DS
 * @{
 * This module provides string manipulation API.
 *
 * \section em_pstr_not_null_sec EMLIB String is NOT Null Terminated!
 *
 * That is the first information that developers need to know. Instead
 * of using normal C string, strings in EMLIB are represented as
 * em_str_t structure below:
 *
 * <pre>
 ...
 *
 * Most of APIs in EMLIB that expect or return string will represent
 * the string as em_str_t instead of normal C string.
 *
 * \section em_pstr_examples_sec Examples
 *
 ...
 * @return the string.
 */
EM_INLINE(em_str_t*) em_strset( em_str_t *str, char *ptr, em_size_t length)
{
    str->ptr = ptr;
    str->slen = (em_ssize_t)length;
    return str;
}
 ...
 * @return the string.
 */
EM_INLINE(em_str_t*) em_strset2( em_str_t *str, char *src)
{
    str->ptr = src;
    str->slen = src ? (em_ssize_t)strlen(src) : 0;
    return str;
}
 ...
 */
EM_INLINE(em_str_t*) em_strset3( em_str_t *str, char *begin, char *end )
{
    str->ptr = begin;
 ...
 * @return the target string.
 */
EM_IDECL(em_str_t*) em_strcpy(em_str_t *dst, const em_str_t *src);
 ...
 * @return the target string.
 */
EM_IDECL(em_str_t*) em_strcpy2(em_str_t *dst, const char *src);
 ...
 * @return the target string.
 */
EM_IDECL(em_str_t*) em_strncpy(em_str_t *dst, const em_str_t *src, 
        em_ssize_t max);
 ...
 * @return the target string.
 */
EM_IDECL(em_str_t*) em_strncpy_with_null(em_str_t *dst, const em_str_t *src,
        em_ssize_t max);
 ...
 */
EM_IDECL(em_str_t*) em_strdup(em_pool_t *pool,
        em_str_t *dst, const em_str_t *src);
 ...
 * @return	    The string result.
 */
EM_IDECL(em_str_t*) em_strdup_with_null(em_pool_t *pool,
        em_str_t *dst,
        const em_str_t *src);
 ...
 * @return the string result.
 */
EM_IDECL(em_str_t*) em_strdup2(em_pool_t *pool,
        em_str_t *dst,
        const char *src);
 ...
 * @return	    The string result.
 */
EM_IDECL(em_str_t*) em_strdup2_with_null(em_pool_t *pool,
        em_str_t *dst,
        const char *src);
 ...
 * @return the string result.
 */
EM_IDECL(em_str_t) em_strdup3(em_pool_t *pool, const char *src);
 ...
 * @return the length of the string.
 */
EM_INLINE(em_size_t) em_strlen( const em_str_t *str )
{
    return str->slen;
}
 ...
 */
EM_INLINE(const char*) em_strbuf( const em_str_t *str )
{
    return str->ptr;
}
 ...
 */
EM_IDECL(int) em_strcmp( const em_str_t *str1, const em_str_t *str2);
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_strcmp2( const em_str_t *str1, const char *str2 );
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_strncmp( const em_str_t *str1, const em_str_t *str2, 
        em_size_t len);
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_strncmp2( const em_str_t *str1, const char *str2, 
        em_size_t len);
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_stricmp(const em_str_t *str1, const em_str_t *str2);
...
EM_IDECL(int) strnicmp_alnum(const char *str1, const char *str2,
        int len);
#else
#define strnicmp_alnum	em_ansi_strnicmp
#endif
 ...
 */
#if defined(EM_HAS_STRICMP_ALNUM) && EM_HAS_STRICMP_ALNUM!=0
EM_IDECL(int) em_stricmp_alnum(const em_str_t *str1, const em_str_t *str2);
#else
#define em_stricmp_alnum    em_stricmp
#endif
#endif
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_stricmp2( const em_str_t *str1, const char *str2);
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_strnicmp( const em_str_t *str1, const em_str_t *str2, 
        em_size_t len);
 ...
 *      - > 0 if str1 is greater than str2
 */
EM_IDECL(int) em_strnicmp2( const em_str_t *str1, const char *str2, 
        em_size_t len);
 ...
 * @param src	    The source string.
 */
EM_IDECL(void) em_strcat2(em_str_t *dst, const char *src);
 ...
 */
EM_INLINE(char*) em_strchr( const em_str_t *str, int chr)
{
    if (str->slen == 0)
        return NULL;
 ...
 */
EM_DECL(em_ssize_t) em_strspn(const em_str_t *str, const em_str_t *set_char);
 ...
 * set_char. If str starts with a character not in set_char, return 0.
 */
EM_DECL(em_ssize_t) em_strspn2(const em_str_t *str, const char *set_char);
 ...
 */
EM_DECL(em_ssize_t) em_strcspn(const em_str_t *str, const em_str_t *set_char);
 ...
 * set_char. If no match is found, return the length of str.
 */
EM_DECL(em_ssize_t) em_strcspn2(const em_str_t *str, const char *set_char);
 ...
 */
EM_DECL(em_ssize_t) em_strtok(const em_str_t *str, const em_str_t *delim,
 ...
 * if the token is not found.
 */
EM_DECL(em_ssize_t) em_strtok2(const em_str_t *str, const char *delim,
        em_str_t *tok, em_size_t start_idx);
 ...
 */
EM_DECL(char*) em_strstr(const em_str_t *str, const em_str_t *substr);

/**
 * Performs substring lookup like em_strstr() but ignores the case of
 * both strings.
 *
 * @param str	    The string to search.
 * @param substr    The string to search fo.
 ...
 *         is pointing to non-NULL terminated string.
 */
EM_DECL(char*) em_stristr(const em_str_t *str, const em_str_t *substr);
 ...
 * @return the string.
 */
EM_DECL(em_str_t*) em_strltrim( em_str_t *str );
 ...
 * @return the string.
 */
EM_DECL(em_str_t*) em_strrtrim( em_str_t *str );
 ...
 * @return the string.
 */
EM_IDECL(em_str_t*) em_strtrim( em_str_t *str );
 ...
 * @return the string.
 */
EM_DECL(char*) em_create_random_string(char *str, em_size_t length);
 ...
 * @return the integer.
 */
EM_DECL(long) em_strtol(const em_str_t *str);
 ...
 *
 * @return EM_SUCC if successful.  Otherwise:
 *         EM_ETOOSMALL if the value was an impossibly long negative number.
 *         In this case *value will be set to LONG_MIN.
 *         \n
 *         EM_ETOOBIG if the value was an impossibly long positive number.
 *         In this case, *value will be set to LONG_MAX.
 *         \n
 *         EM_EINVAL if the input string was NULL, the value pointer was NULL 
 ...
 */
EM_DECL(emlib_ret_t) em_strtol2(const em_str_t *str, long *value);
 ...
 */
EM_DECL(unsigned long) em_strtoul(const em_str_t *str);
 ...
 */
EM_DECL(unsigned long) em_strtoul2(const em_str_t *str, em_str_t *endptr,
        unsigned base);
 ...
 */
EM_DECL(emlib_ret_t) em_strtoul3(const em_str_t *str, unsigned long *value,
        unsigned base);
 ...
 * @return the value.
 */
EM_DECL(float) em_strtof(const em_str_t *str);
 ...
 */
EM_DECL(int) em_utoa(unsigned long val, char *buf);
 ...
 * @return the number of characters written.
 */
EM_DECL(int) em_utoa_pad( unsigned long val, char *buf, int min_dig, int pad);
 ...
 */
EM_INLINE(void) em_bzero(void *dst, em_size_t size)
{
#if defined(EM_HAS_BZERO) && EM_HAS_BZERO!=0
    bzero(dst, size);
#else
    memset(dst, 0, size);
#endif
 ...
 */
EM_INLINE(void*) em_memset(void *dst, int c, em_size_t size)
{
 ...
 */
EM_INLINE(void*) em_memcpy(void *dst, const void *src, em_size_t size)
{
 ...
 * @return the destination buffer.
 */
EM_INLINE(void*) em_memmove(void *dst, const void *src, em_size_t size)
{
 ...
 */
EM_INLINE(int) em_memcmp(const void *buf1, const void *buf2, em_size_t size)
{
 ...
 *         not found.
 */
EM_INLINE(void*) em_memchr(const void *buf, int c, em_size_t size)
{
